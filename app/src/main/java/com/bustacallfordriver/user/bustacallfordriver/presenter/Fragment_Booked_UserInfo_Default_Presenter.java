...
import com.bustacallfordriver.user.bustacallfordriver.view.Fragment_Booked_UserInfo_Default;
...
public class Fragment_Booked_UserInfo_Default_Presenter {

    Fragment_Booked_UserInfo_Default view;
    Dialog_Progress dialog_progress;

    public Fragment_Booked_UserInfo_Default_Presenter(Fragment_Booked_UserInfo_Default view){
        this.view = view;
