...
import com.bustacallfordriver.user.bustacallfordriver.view.Fragment_Signin_License;
...
public class Fragment_Signin_License_Presenter {
    ...
    public void request_mainlogin_bus() {
        ...
        RequestBody point = RequestBody.create(MediaType.parse("text/plain"), app.getBus().getPoint());
        ...
        Call<Void> retrofitinfo = retrofit_user.request_mainlogin_bus(nickname, phonenum, birthday, bus_region,
                bus_group, bank, accountNum, bus_num, bus_type, bus_career, bus_age, point, body);
