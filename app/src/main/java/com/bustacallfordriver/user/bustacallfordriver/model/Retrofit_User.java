...
public interface Retrofit_User {
    ...
    Call<Void> request_mainlogin_bus(@Part("nickname") RequestBody nickname, @Part("phone_num") RequestBody phonenum, @Part("birthday") RequestBody birthday,
                                     ...
                                     @Part("bus_num") RequestBody bus_num, @Part("bus_type") RequestBody bus_type, @Part("bus_career") RequestBody bus_career,
                                     @Part("bus_age") RequestBody bus_age, @Part("point") RequestBody point, @Part MultipartBody.Part[] image1);
