...
import com.bustacallfordriver.user.bustacallfordriver.view.Fragment_RentalDetail_TwoWay;
...
public class Fragment_RentalDetail_TwoWay_Presenter {
    Fragment_RentalDetail_TwoWay view;

    public Fragment_RentalDetail_TwoWay_Presenter(Fragment_RentalDetail_TwoWay view){
        this.view = view;
    }
